...
from src.brw.exceptions import InvalidDate, StationNotFound
from src.brw.validator import RouteValidator
from src.brw.stations import get_station_code


def test_existing_stations(mocker):
    mocker.patch("src.brw.stations.load_stations", return_value={"Минск": "2100000"})
