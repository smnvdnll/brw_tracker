...
class BRWMessages(Enum):
    ...
    incorrect_arrival_station = "Станция прибытия не найдена, попробуйте еще раз" # TODO учитывать, что может и не найтись
    ...
    incorrect_train_number = "Вы не ввели номер поезда"
